...
> 创建时间：2026-05-14  
> 状态：历史初始 spec，当前实现状态以仓库根目录 `README.md` 和代码为准

---

## Context

这是一个面向求职者的 AI 情报助手。用户粘贴 JD 链接 + 上传简历，Agent 自主调研，3-5 分钟生成专属面试情报报告。本文档记录项目从初始脚手架推进到完整链路的开发计划；当前项目已落地核心业务链路，最新能力说明见仓库根目录 `README.md`。
